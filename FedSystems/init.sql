CREATE TABLE bank_details (
  primary_routing_transit_number VARCHAR(9) PRIMARY KEY,
  legal_name VARCHAR(256) NOT NULL,
  federal_employer_identification_number NUMERIC,
  master_account_rtn VARCHAR(9) UNIQUE,
...
CREATE TABLE running_balance (
  master_account_rtn VARCHAR(9) PRIMARY KEY REFERENCES bank_details(master_account_rtn),
...
CREATE TABLE central_ledger_entries (
  ...
  master_account_rtn VARCHAR(9) REFERENCES bank_details(master_account_rtn),
